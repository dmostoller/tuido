...
1. **Get API Token**: Visit [tuido.dev](https://tuido.dev) and sign in with Google
2. **Configure in App**: Press `s` to open Settings, go to Cloud Sync tab, paste your API token
