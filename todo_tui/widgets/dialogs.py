...
from ..encryption import delete_device_credentials, has_device_token
            ...
            with TabbedContent(initial="general-tab"):
                ...
                with TabPane(f"{Icons.CLOUD} Cloud Sync", id="cloud-tab"):
                    ...
                    yield Input(
                        ...
                        placeholder="Set password for end-to-end encryption",
    ...
    def _update_auth_status(self, result: AuthorizationResult) -> None:
        ...
        if result.status == "pending":
            ...
            if result.user_email:
                ...
                auth_status_container.mount(
                    Static(user_info, classes="user-info")
                )
